...
<head>
    ...
    <title>Php lite framework</title>
    <style>
        body {
            display: flex;
            min-height: 100vh;
    ...
    <nav class="row deep-purple darken-3">
        <div class="col s12">
            <ul class="right">
                ...
                <li class="right">
                    <a href="https://github.com/mohammadaktaa1995/framework" target="_blank" class="fa fa-github-square fa-2x waves-effect waves-light"><span class="icon-text"></span></a>
                </li>
            </ul>
        </div>
    </nav>
...
<footer class="page-footer deep-purple darken-3">
    <div class="footer-copyright deep-purple darken-4">
        <div class="container">
            <time>&copy; {{date('Y')}} Mohammad Aktaa</time>
        </div>
    </div>
</footer>
